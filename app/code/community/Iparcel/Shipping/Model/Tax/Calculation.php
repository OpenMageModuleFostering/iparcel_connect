...
class Iparcel_Shipping_Model_Tax_Calculation extends Mage_Tax_Model_Calculation{
	...
	public function getRate($request)
	{
		...
		if (!$quote->getId() || Mage::getStoreConfig('iparcel/tax/mode') == Iparcel_Shipping_Model_System_Config_Source_Tax_Mode::DISABLED || $quote->isVirtual() || explode('_',$quote->getShippingAddress()->getShippingMethod())[0] != 'i-parcel'){
